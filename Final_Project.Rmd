...
```{r, creating a map, results = "hide"}
# filtering cps_svy to the desired year, grouping to state, and getting the mean unemployment
df1 <- cps_svy %>%
...
Looking at the results of the logistic regression below, we see that our model predicts exclusively zeros, 
```{r log-assessment}
